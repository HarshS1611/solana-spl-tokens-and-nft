...
try {
    ...
    console.log(`Mint address: ${mint.address} and transaction signature: ${signature}`);
}
catch (error) {
    console.log(error);
}
...
// Mint address: 6oypof8YFDSkumpqui37DEADD4F1nc9cECVoJ3ZVAVow and transaction signature: 4Di1qxBeB5QZkxH2keiBBBvJaxtYg9GPSD4GdVR6WsHNfA4aa6EF1W7jE8bvT2VzGkeNCNAK7vQLJdeGpiome5wz